...
namespace Utils
{
    ...
    ESM::RefId getActiveEffectIdFromLegacyIndex(int effectId);
    int getLegacyIndexFromActiveEffectId(ESM::RefId effectId);
    std::variant<ESM::RefId, ESM::RefNum> getActiveEffectArgFromLegacyIndex(ESM::RefId effectId, int arg);
    int getLegacyIndexFromActiveEffectArg(const ESM::ActiveEffect& effect);
}
#endif //UTILS_HPP
