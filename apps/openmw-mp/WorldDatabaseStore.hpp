...
namespace mwmp
{
    ...
    struct WorldRecordWinner
    {
        ...
        std::size_t itemEquipmentSlotCount = 0;
        ...
        int itemEquipmentWeaponMaxDamage = 0;
        int itemEquipmentWeaponChopMinDamage = 0;
        int itemEquipmentWeaponChopMaxDamage = 0;
        int itemEquipmentWeaponSlashMinDamage = 0;
        int itemEquipmentWeaponSlashMaxDamage = 0;
        int itemEquipmentWeaponThrustMinDamage = 0;
        int itemEquipmentWeaponThrustMaxDamage = 0;
        int itemEquipmentWeaponAmmoType = -1;
