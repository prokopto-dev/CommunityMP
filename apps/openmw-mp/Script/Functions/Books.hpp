...
#define BOOKAPI \
    ...
    {"SetBookChangesAreLoad",  BookFunctions::SetBookChangesAreLoad},\
    \
...
public:
    ...
    */
    ...
    /**
    * \brief Mark the current book changes as saved character state instead of new gameplay changes.
    *
    * Clients use this to hydrate a selected character's read-book list after clearing local book state.
    *
    * \param pid The player ID whose book changes should be marked.
    * \param value Whether the current book changes are a load/hydration packet.
    * \return void
    */
    static void SetBookChangesAreLoad(unsigned short pid, bool value) noexcept;
