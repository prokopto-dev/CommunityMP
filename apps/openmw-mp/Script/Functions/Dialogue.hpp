...
#define DIALOGUEAPI \
    ...
    {"SetTopicChangesAreLoad",  DialogueFunctions::SetTopicChangesAreLoad},\
    \
...
public:
    ...
    */
    ...
    /**
    * \brief Mark the current topic changes as saved character state instead of new gameplay changes.
    *
    * Clients use this to hydrate a selected character's topic list after clearing local topics.
    *
    * \param pid The player ID whose topic changes should be marked.
    * \param value Whether the current topic changes are a load/hydration packet.
    * \return void
    */
    static void SetTopicChangesAreLoad(unsigned short pid, bool value) noexcept;
