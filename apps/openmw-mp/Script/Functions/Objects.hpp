...
#define OBJECTAPI \
    ...
    {"GetObjectDoorTeleportState",            ObjectFunctions::GetObjectDoorTeleportState},\
    {"GetObjectDoorDestinationCell",          ObjectFunctions::GetObjectDoorDestinationCell},\
    {"GetObjectDoorDestinationPosX",          ObjectFunctions::GetObjectDoorDestinationPosX},\
    {"GetObjectDoorDestinationPosY",          ObjectFunctions::GetObjectDoorDestinationPosY},\
    {"GetObjectDoorDestinationPosZ",          ObjectFunctions::GetObjectDoorDestinationPosZ},\
    {"GetObjectDoorDestinationRotX",          ObjectFunctions::GetObjectDoorDestinationRotX},\
    {"GetObjectDoorDestinationRotZ",          ObjectFunctions::GetObjectDoorDestinationRotZ},\
    ...
    {"SetContainerItemActionCount",           ObjectFunctions::SetContainerItemActionCount},\
...
public:
    ...
    *                  4 for REPLY_TO_REQUEST, 5 for RESTOCK_RESULT, 6 for BARTER,
    *                  7 for LOCK_REQUEST, 8 for LOCK_RELEASE).
    */
    ...
    */
    ...
    /**
    * \brief Get whether the door at a certain index teleports to another cell.
    *
    * \param index The index of the object.
    * \return Whether the door has a teleport destination.
    */
    static bool GetObjectDoorTeleportState(unsigned int index) noexcept;

    /**
    * \brief Get the destination cell of the teleport door at a certain index.
    *
    * \param index The index of the object.
    * \return The destination cell description.
    */
    static const char* GetObjectDoorDestinationCell(unsigned int index) noexcept;

    /**
    * \brief Get the X position of the teleport door destination at a certain index.
    *
    * \param index The index of the object.
    * \return The X position.
    */
    static double GetObjectDoorDestinationPosX(unsigned int index) noexcept;

    /**
    * \brief Get the Y position of the teleport door destination at a certain index.
    *
    * \param index The index of the object.
    * \return The Y position.
    */
    static double GetObjectDoorDestinationPosY(unsigned int index) noexcept;

    /**
    * \brief Get the Z position of the teleport door destination at a certain index.
    *
    * \param index The index of the object.
    * \return The Z position.
    */
    static double GetObjectDoorDestinationPosZ(unsigned int index) noexcept;

    /**
    * \brief Get the X rotation of the teleport door destination at a certain index.
    *
    * \param index The index of the object.
    * \return The X rotation.
    */
    static double GetObjectDoorDestinationRotX(unsigned int index) noexcept;

    /**
    * \brief Get the Z rotation of the teleport door destination at a certain index.
    *
    * \param index The index of the object.
    * \return The Z rotation.
    */
    static double GetObjectDoorDestinationRotZ(unsigned int index) noexcept;
    ...
    */
    ...
    /**
    * \brief Set the action count of the temporary container item stored on the server.
    *
    * \param actionCount The action count.
    * \return void
    */
    static void SetContainerItemActionCount(int actionCount) noexcept;
