...
#define ACTORAPI \
    ...
    {"DoesActorHaveAI",                        ActorFunctions::DoesActorHaveAI},\
    {"DoesActorHaveAITarget",                  ActorFunctions::DoesActorHaveAITarget},\
    {"DoesActorAITargetPlayer",                ActorFunctions::DoesActorAITargetPlayer},\
    ...
    {"GetActorAIPosX",                         ActorFunctions::GetActorAIPosX},\
    {"GetActorAIPosY",                         ActorFunctions::GetActorAIPosY},\
    {"GetActorAIPosZ",                         ActorFunctions::GetActorAIPosZ},\
...
public:
    ...
    */
    ...
    /**
    * \brief Check whether there is any AI data for the actor at a certain index in
    * the read actor list.
    *
    * This is only useful when reading the actor list data recorded for a particular cell.
    *
    * \param index The index of the actor.
    * \return Whether the read actor list contains AI data.
    */
    static bool DoesActorHaveAI(unsigned int index) noexcept;

    /**
    * \brief Check whether the actor at a certain index has an AI target.
    *
    * \param index The index of the actor.
    * \return Whether the actor has an AI target.
    */
    static bool DoesActorHaveAITarget(unsigned int index) noexcept;

    /**
    * \brief Check whether the actor at a certain index has a player AI target.
    *
    * \param index The index of the actor.
    * \return Whether the actor's AI target is a player.
    */
    static bool DoesActorAITargetPlayer(unsigned int index) noexcept;

    /**
    * \brief Get the AI action of the actor at a certain index.
    *
    * \param index The index of the actor.
    ...
    */
    ...
    /**
    * \brief Get the AI wander distance of the actor at a certain index.
    *
    * \param index The index of the actor.
    * \return The AI distance.
    */
    static unsigned int GetActorAIDistance(unsigned int index) noexcept;

    /**
    * \brief Get the AI duration of the actor at a certain index.
    *
    * \param index The index of the actor.
    * \return The AI duration.
    */
    static unsigned int GetActorAIDuration(unsigned int index) noexcept;

    /**
    * \brief Get the AI repetition flag of the actor at a certain index.
    *
    * \param index The index of the actor.
    * \return Whether the AI package should repeat.
    */
    static bool GetActorAIRepetition(unsigned int index) noexcept;

    /**
    * \brief Get the AI X coordinate of the actor at a certain index.
    *
    * \param index The index of the actor.
    * \return The AI X coordinate.
    */
    static double GetActorAIPosX(unsigned int index) noexcept;

    /**
    * \brief Get the AI Y coordinate of the actor at a certain index.
    *
    * \param index The index of the actor.
    * \return The AI Y coordinate.
    */
    static double GetActorAIPosY(unsigned int index) noexcept;

    /**
    * \brief Get the AI Z coordinate of the actor at a certain index.
    *
    * \param index The index of the actor.
    * \return The AI Z coordinate.
    */
    static double GetActorAIPosZ(unsigned int index) noexcept;

    /**
    * \brief Get the player ID of the actor's AI target at a certain index.
    *
    * \param index The index of the actor.
    * \return The player ID of the AI target.
    */
    static int GetActorAITargetPid(unsigned int index) noexcept;

    /**
    * \brief Get the refId of the actor's AI target at a certain index.
    *
    * \param index The index of the actor.
    * \return The AI target refId.
    */
    static const char *GetActorAITargetRefId(unsigned int index) noexcept;

    /**
    * \brief Get the refNum of the actor's AI target at a certain index.
    *
    * \param index The index of the actor.
    * \return The AI target refNum.
    */
    static unsigned int GetActorAITargetRefNum(unsigned int index) noexcept;

    /**
    * \brief Get the mpNum of the actor's AI target at a certain index.
    *
    * \param index The index of the actor.
    * \return The AI target mpNum.
    */
