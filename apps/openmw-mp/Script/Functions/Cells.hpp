...
#define CELLAPI \
    ...
    {"GetCellChangeReason",     CellFunctions::GetCellChangeReason},\
    ...
    {"SetExterior",             CellFunctions::SetExteriorCell},\
...
public:
    ...
    */
    ...
    /**
    * \brief Get the source reason carried by the player's latest cell change packet.
    *
    * \param pid The player ID.
    * \return The cell change reason enum value.
    */
    static unsigned int GetCellChangeReason(unsigned short pid) noexcept;

    /**
    * \brief Check whether a cell is explicitly opted into server-side simulation while empty.
    *
    * \param cellDescription The cell description.
    * \return Whether the cell has server-script simulation interest.
    */
    static bool GetCellSimulationInterest(const char *cellDescription) noexcept;
    ...
    */
    ...
    /**
    * \brief Set the reason carried by the next cell change packet sent for a player.
    *
    * \param pid The player ID.
    * \param reason The cell change reason enum value.
    * \return void
    */
    static void SetCellChangeReason(unsigned short pid, unsigned int reason) noexcept;
    ...
    */
    ...
    /**
    * \brief Set whether a cell should remain eligible for server-side simulation without players.
    *
    * \param cellDescription The cell description.
    * \param enabled Whether server-script simulation interest is enabled.
    * \return void
    */
    static void SetCellSimulationInterest(const char *cellDescription, bool enabled) noexcept;
