...
#define MECHANICSAPI \
    ...
    {"GetSelectedEnchantedItemRefId", MechanicsFunctions::GetSelectedEnchantedItemRefId},\
    {"GetSelectedEnchantedItemCount", MechanicsFunctions::GetSelectedEnchantedItemCount},\
    {"GetSelectedEnchantedItemCharge", MechanicsFunctions::GetSelectedEnchantedItemCharge},\
    {"GetSelectedEnchantedItemEnchantmentCharge", MechanicsFunctions::GetSelectedEnchantedItemEnchantmentCharge},\
    {"GetSelectedEnchantedItemSoul", MechanicsFunctions::GetSelectedEnchantedItemSoul},\
    \
    ...
    {"SetSelectedEnchantedItem",     MechanicsFunctions::SetSelectedEnchantedItem},\
    \
    ...
    {"SendSelectedEnchantedItem",    MechanicsFunctions::SendSelectedEnchantedItem},\
...
public:
    ...
    */
    ...
    /**
    * \brief Get the refId of a player's selected enchanted item.
    *
    * \param pid The player ID.
    * \return The item refId.
    */
    static const char *GetSelectedEnchantedItemRefId(unsigned short pid) noexcept;

    /**
    * \brief Get the count of a player's selected enchanted item.
    *
    * \param pid The player ID.
    * \return The item count.
    */
    static int GetSelectedEnchantedItemCount(unsigned short pid) noexcept;

    /**
    * \brief Get the remaining charge of a player's selected enchanted item.
    *
    * \param pid The player ID.
    * \return The item charge.
    */
    static int GetSelectedEnchantedItemCharge(unsigned short pid) noexcept;

    /**
    * \brief Get the enchantment charge of a player's selected enchanted item.
    *
    * \param pid The player ID.
    * \return The enchantment charge.
    */
    static double GetSelectedEnchantedItemEnchantmentCharge(unsigned short pid) noexcept;

    /**
    * \brief Get the soul stored in a player's selected enchanted item.
    *
    * \param pid The player ID.
    * \return The stored soul refId.
    */
    static const char *GetSelectedEnchantedItemSoul(unsigned short pid) noexcept;
    ...
    */
    ...
    /**
    * \brief Set the selected enchanted item stored for a player.
    *
    * This changes the item recorded for that player in the server memory, but does not by itself
    * send a packet.
    *
    * \param pid The player ID.
    * \param refId The item refId.
    * \param count The item count.
    * \param charge The remaining item charge.
    * \param enchantmentCharge The remaining enchantment charge.
    * \param soul The stored soul refId.
    * \return void
    */
    static void SetSelectedEnchantedItem(unsigned short pid, const char *refId, int count, int charge,
    ...
    */
    ...
    /**
    * \brief Send a PlayerMiscellaneous packet with a selected enchanted item to a player.
    *
    * \param pid The player ID.
    * \return void
    */
    static void SendSelectedEnchantedItem(unsigned short pid);
