...
#define QUESTAPI \
    ...
    {"AddJournalFinished",                QuestFunctions::AddJournalFinished},\
    {"SetJournalChangesAreLoad",          QuestFunctions::SetJournalChangesAreLoad},\
    \
    ...
    {"GetJournalItemFinished",            QuestFunctions::GetJournalItemFinished},\
    \
...
public:
    ...
    */
    ...
    /**
    * \brief Add a new journal item of type FINISHED to the journal changes for a player.
    *
    * \param pid The player ID whose journal changes should be used.
    * \param quest The quest of the journal item.
    * \param isFinished Whether the quest should be marked finished.
    * \return void
    */
    static void AddJournalFinished(unsigned short pid, const char* quest, bool isFinished) noexcept;

    /**
    * \brief Mark the current journal changes as saved character state instead of new gameplay changes.
    *
    * Clients use this to hydrate a selected character's journal without showing new journal update popups.
    *
    * \param pid The player ID whose journal changes should be marked.
    * \param value Whether the current journal changes are a load/hydration packet.
    * \return void
    */
    static void SetJournalChangesAreLoad(unsigned short pid, bool value) noexcept;
    ...
    */
    ...
    /**
    * \brief Get the finished state at a certain index in a player's latest journal changes.
    *
    * \param pid The player ID whose journal changes should be used.
    * \param index The index of the journalItem.
    * \return The finished state.
    */
    static bool GetJournalItemFinished(unsigned short pid, unsigned int index) noexcept;
