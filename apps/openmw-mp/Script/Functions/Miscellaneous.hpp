...
#define MISCELLANEOUSAPI \
    ...
    {"GetHandshakePasswordHash",     MiscellaneousFunctions::GetHandshakePasswordHash},\
    {"ClearHandshakePasswordHash",   MiscellaneousFunctions::ClearHandshakePasswordHash},\
    \
...
public:
    ...
    */
    ...
    /**
    * \brief Get the pre-connect account password hash sent by a player's system handshake.
    *
    * \param pid The player ID.
    * \return The account password hash, or an empty string when none was sent.
    */
    static const char *GetHandshakePasswordHash(unsigned short pid) noexcept;

    /**
    * \brief Clear the pre-connect account password hash sent by a player's system handshake.
    *
    * \param pid The player ID.
    * \return void
    */
    static void ClearHandshakePasswordHash(unsigned short pid) noexcept;
