...
public:
    ...
    */
    ...
    static constexpr ScriptFunctionSignatureData signatures[]{ SCRIPT_FUNCTIONS_TABLE };
    static const ScriptFunctionData functions[sizeof(signatures) / sizeof(signatures[0])];
    ...
    static constexpr ScriptCallbackData callbacks[]{
            ...
            {"OnPlayerStatsDynamic",     Callback<unsigned short>()},
            ...
            {"OnDoorDestination",        Callback<unsigned short, const char*>()},
            ...
            {"OnActorStatsDynamic",      Callback<unsigned short, const char*>()},
            ...
            {"OnPlayerBaseInfo",         Callback<unsigned short>()},
            {"OnPlayerCharClass",        Callback<unsigned short>()},
