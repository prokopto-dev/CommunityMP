        ...
        try
        {
            ...
            mStats.recordWinnerCount = readJsonlTable(root, "record_winners.jsonl", recordWinnerRowSchema,
                [&](const boost::property_tree::ptree& row) {
                    ...
                    winner.itemEquipmentImported = getBool(row, "itemEquipmentImported");
                    winner.itemEquipmentSlotCount = getSizeT(row, "itemEquipmentSlotCount");
                    ...
                    winner.itemEquipmentWeaponMaxDamage = getInt(row, "itemEquipmentWeaponMaxDamage");
                    winner.itemEquipmentWeaponChopMinDamage = getInt(row, "itemEquipmentWeaponChopMinDamage");
                    winner.itemEquipmentWeaponChopMaxDamage = getInt(row, "itemEquipmentWeaponChopMaxDamage");
                    winner.itemEquipmentWeaponSlashMinDamage = getInt(row, "itemEquipmentWeaponSlashMinDamage");
                    winner.itemEquipmentWeaponSlashMaxDamage = getInt(row, "itemEquipmentWeaponSlashMaxDamage");
                    winner.itemEquipmentWeaponThrustMinDamage = getInt(row, "itemEquipmentWeaponThrustMinDamage");
                    winner.itemEquipmentWeaponThrustMaxDamage = getInt(row, "itemEquipmentWeaponThrustMaxDamage");
                    winner.itemEquipmentWeaponAmmoType = getInt(row, "itemEquipmentWeaponAmmoType", -1);
