...
namespace MWPhysics
{
    ...
    public:
        ...
        virtual std::vector<DynamicBodySnapshot> getDynamicBodySnapshots() const { return {}; }
        ...
        virtual osg::Vec3f getInertialForce(const MWWorld::ConstPtr& actor) const = 0;
        virtual void setInertialForce(const MWWorld::Ptr& actor, const osg::Vec3f& force) = 0;
