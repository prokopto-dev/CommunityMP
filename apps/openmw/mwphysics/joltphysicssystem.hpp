...
namespace MWPhysics
{
    ...
    public:
        ...
        osg::Vec3f getInertialForce(const MWWorld::ConstPtr& actor) const override;
        void setInertialForce(const MWWorld::Ptr& actor, const osg::Vec3f& force) override;
        ...
        std::vector<DynamicBodySnapshot> getDynamicBodySnapshots() const override;
