...
namespace mwmp
{
    ...
    public:
        ...
        bool hasServerActorAuthority() const;
        void setAuthority(const PacketGuid& guid);
        void setServerActorAuthority(bool enabled);
    ...
    private:
        ...
        PacketGuid authorityGuid;
        bool serverActorAuthority;
