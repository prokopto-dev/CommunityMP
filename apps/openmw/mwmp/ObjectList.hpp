...
namespace mwmp
{
    ...
    public:
        ...
        void registerServerObjectId(const MWWorld::Ptr& ptr, unsigned int mpNum);
        unsigned int getServerMpNum(const MWWorld::Ptr& ptr) const;
        std::optional<unsigned int> getLocalRefNumForServerMpNum(unsigned int mpNum) const;
        ...
        void openGrantedContainers(MWWorld::CellStore* cellStore);
        ...
        void addObjectDialogueChoiceByType(
        ...
        void addObjectMove(const MWWorld::Ptr& ptr, const ESM::Position& pos);
        void addObjectRotate(const MWWorld::Ptr& ptr, const ESM::Position& pos);
    ...
    private:
        ...
        std::unordered_map<unsigned int, unsigned int> localRefNumToMpNum;
        std::unordered_map<unsigned int, unsigned int> mpNumToLocalRefNum;
        std::unordered_set<unsigned int> pendingLocalObjectIdAssignments;
