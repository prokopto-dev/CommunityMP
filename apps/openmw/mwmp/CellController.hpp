...
namespace mwmp
{
    ...
    public:
        ...
        std::pair<unsigned int, unsigned int> getActorNetworkId(const MWWorld::Ptr& ptr) const;
        ...
        void applyActorAuthority(const ESM::Cell& cell, const PacketGuid& guid);
        void queueActorAuthority(const ESM::Cell& cell, const PacketGuid& guid);
    ...
    private:
        ...
        static std::map<std::string, PacketGuid> queuedAuthorityGuids;

        bool applyQueuedActorAuthority(const ESM::Cell& cell);
    };
}
