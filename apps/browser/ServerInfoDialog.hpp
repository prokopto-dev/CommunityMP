...
public:
    ...
    bool isUpdated();
    void setData(std::pair<mwmp::PacketAddress, QueryData> &newSD);
    void setDirectReachable(bool reachable);
public slots:
    void refresh();
...
private:
    ...
    ThrWorker* worker;
    std::pair<mwmp::PacketAddress, QueryData> sd;
    QString mAddr;
    unsigned short mPort;
    bool mDirectReachable;
};
