...
namespace CSVWorld
{
    ...
    public:
        NotEditableSubDelegate(const CSMWorld::IdTable* table, QObject* parent = nullptr);
    ...
    public:
        EditWidget(QWidget* parent, int row, CSMWorld::IdTable* table, CSMWorld::CommandDispatcher& commandDispatcher,
