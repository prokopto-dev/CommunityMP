Menus["help player"] = {
    text = color.Orange .. "Player command list:\n" ..
        ...
        color.Yellow .. "/message <pid> <text>\n" ..
            ...
            color.Yellow .. "(/msg)\n" ..
        color.Yellow .. "/ooc <text>\n" ..
            color.White .. "Send a global out-of-character message " ..
            color.Yellow .. "(/global, /g)\n" ..
        color.Yellow .. "/me <text>\n" ..
            color.White .. "Send a message written in the third person\n" ..
        color.Yellow .. "/ic <text>\n" ..
            color.White .. "Send a local in-character message\n" ..
