...
enumerations.journal = { ENTRY = 0, INDEX = 1, FINISHED = 2 }
enumerations.log = { VERBOSE = 0, INFO = 1, WARN = 2, ERROR = 3, FATAL = 4 }
enumerations.miscellaneous = { MARK_LOCATION = 0, SELECTED_SPELL = 1, SELECTED_ENCHANTED_ITEM = 2 }
enumerations.cellChangeReason = {
    NORMAL = 0,
    DOOR = 1,
    MAGIC_RECALL = 2,
    MAGIC_DIVINE_INTERVENTION = 3,
    MAGIC_ALMSIVI_INTERVENTION = 4,
    RESPAWN = 5,
    GUIDED_TRAVEL = 6,
    SCRIPT = 7,
    JAIL = 8,
