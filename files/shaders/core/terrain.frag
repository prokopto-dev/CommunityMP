...
// Twin of compatibility/terrain.frag, kept under the 'core' tree so the GLSL
// linker can match the GL 4.0 tessellation stages. Functionally identical;
// only the #version directive differs.
